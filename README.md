...
* **Conceptual Validation:** Used to discuss the architectural trade-offs of Big O time versus space complexity during the parsing phase.
* **Documentation & Formatting:** Assisted in generating portfolio-ready Doxygen comments and structuring this `README.md` template.
* **Zero Code Generation:** **No core logic was generated by AI**. All linked list manipulations, LIS dynamic programming matrices, and operation cost calculations were 100% manually coded. This ensures a fundamental, defendable understanding of algorithmic logic.
